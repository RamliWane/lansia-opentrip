                ...
                <section>
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    {dest.highlights.map((h, i) => (
                      <div key={i} className="flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl bg-[#df7224] text-white text-xs sm:text-sm font-semibold">
                    ...
                    <div key={idx} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                      ...
                      <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-2rem)] p-3.5 sm:p-5 rounded-2xl bg-white shadow-sm border border-gray-100 transition-all hover:shadow-md hover:border-[#df7224]/30">
                        <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                          ...
                          <span className="text-[10px] sm:text-xs font-semibold text-white bg-[#df7224] px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-md">{shortLocation}</span>
                        </div>
