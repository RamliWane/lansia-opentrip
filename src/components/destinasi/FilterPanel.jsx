...
/**
 * FilterPanel — panel filter sidebar untuk halaman destinasi
 *
 * Props:
 *   destinations   — array semua destinasi
 *   selectedLocation — string lokasi terpilih, "" = semua
 *   setSelectedLocation — setter
 *   priceMin / setPriceMin — number | ""
 *   priceMax / setPriceMax — number | ""
 *   minRating / setMinRating — number (0, 4.0, 4.5, 4.8)
 *   onResetAll — callback reset semua filter
