...
const ParticipantCard = ({ participant, index, onUpdate, onRemove }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span
            className={`hidden sm:inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium border ${
              complete
