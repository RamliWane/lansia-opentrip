...
const DetailsStep = ({ checkout, onNext }) => {
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-white text-xs font-medium bg-primary hover:bg-primary-hover transition-colors"
            >
              <Plus size={14} />
