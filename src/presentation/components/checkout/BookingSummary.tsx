      ...
      {step !== "confirmation" && (
        <div className="px-5 pb-5 space-y-3 border-t border-gray-100 dark:border-zinc-800 pt-4">
          ...
          <button
            ...
            onMouseEnter={e => canContinue && ((e.currentTarget as HTMLElement).style.backgroundColor = "#c8631e")}
            onMouseLeave={e => canContinue && ((e.currentTarget as HTMLElement).style.backgroundColor = "#df7224")}
          >
            {isLoading ? (
              <>
                <div
